...
const LLM_PROVIDERS = [
  { value: 'none', label: 'Rule-based (No API key needed)', description: 'Uses deterministic rules with market data. Fast and free.' },
  { value: 'grok', label: 'Grok (xAI)', description: 'Recommended. Uses Grok API for agent reasoning.' },
